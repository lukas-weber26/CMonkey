...
token * lexer_next_token(lexer * lexer) {
	...
	switch (lexer->current_char) {
		case '=':	
			...
			break;
		case ';':	
			new_token->token_type = SEMICOLON;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '(':	
			new_token->token_type = LPAREN;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case ')':	
			new_token->token_type =RPAREN;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case ',':	
			new_token->token_type =COMMA;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '+':	
			new_token->token_type =PLUS;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '{':	
			new_token->token_type =LBRACE;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '}':	
			new_token->token_type =RBRACE;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '<':	
			new_token->token_type =LT;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '>':	
			new_token->token_type =GT;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '!':	
			new_token->token_type =BANG;
			...
			break;
		case '*':	
			new_token->token_type =ASTERISK;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '-':	
			new_token->token_type =MINUS;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '/':	
			new_token->token_type =SLASH;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		case '\0':	
			new_token->token_type =ENDFILE;
			new_token->token_string = strdup(token_token_to_string(new_token->token_type));
			break;
		default:
			if (is_letter(lexer->current_char)) {
				new_token->token_type =LITTERAL;
